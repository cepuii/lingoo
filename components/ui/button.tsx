  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline:
          "bg-white text-sky-500 hover:bg-slate-100 active:border-t-0 active:border-slate-200  active:border-t-4 active:border-r-2 active:border-l-2",
        secondary:
          "bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0",
        secondaryOutline:
          "bg-white text-green-500 hover:bg-green-100 border-green-200  active:border-t-4 active:border-r-2 active:border-l-2",
        danger:
          "bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0",
        dangerOutline:
          "bg-white text-rose-500 hover:bg-rose-100 border-rose-200  active:border-t-4 active:border-r-2 active:border-l-2",
        super:
          "bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border-b-0",
        superOutline:
          "bg-white text-indigo-500 hover:bg-indigo-100 border-indigo-200  active:border-t-4 active:border-r-2 active:border-l-2",
        sidebar:
